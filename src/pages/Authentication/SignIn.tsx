...
import { Loginfunc } from '../../AllApiCall';
...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      const res = await Loginfunc(sendData);
      console.log(res.success, res, "oooooooooo")
      if (res?.success) {
        toast.success("Sucsessfully Loged In")
        const tokendata = res.token;
        tokendata && localStorage.setItem("token",
